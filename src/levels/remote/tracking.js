    ...
    "sl_SI": {
      "childViews": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Ok! Za to stopnjo pushajmo delo na `main` branch na oddaljenem repotu, medtem ko lokalno *nismo* na `mainju`. Ostalo prepustim tebi, ker je to vseeno napredna stopnja :P"
            ]
          }
        }
      ]
